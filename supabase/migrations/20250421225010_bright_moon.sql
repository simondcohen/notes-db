/*
  ...
  1. New Tables
    ...
    - `note_tags`: Junction table linking notes to tags
      ...
      - Unique constraint on (note_id, tag_id)

  2. Security
    - Enable RLS on both tables
    - Add policies to ensure users can only access their own tags
    - Add policies to ensure users can only tag notes they own
*/
...
ON note_tags FOR ALL TO authenticated
USING (
  EXISTS (
    SELECT 1 FROM notes
